...
const Footer = () => {
  return (
    <div className="border-t-2 border-gray-300">
      <div className="container w-screen mx-auto mt-20">
        <footer className="p-10">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
            <div className="md:col-span-6 lg:col-span-3 w-full">
            ...
            <div className="md:col-span-6 lg:col-span-9 flex gap-3 md:gap-4 flex-wrap">
              <a href="" className="hover:underline">
                Aksesibilitas
              </a>
              <a href="" className="hover:underline">
